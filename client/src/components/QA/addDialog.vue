...
export default {
  ...
  methods: {
    ...
    addRequest(form) {
      return axios.post('/api/qa/add', form, {headers: {'content-type': 'application/json'}})      
    },

    editRequest(form) {
      return axios.put('/api/qa/edit/'+form._id, form, {headers: {'content-type': 'application/json'}})
    },
